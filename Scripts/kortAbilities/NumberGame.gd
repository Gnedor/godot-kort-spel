...
func trigger_ability(card_reference, battle_manager_reference, deck_reference, card_manager_reference):
	...
	card_manager_reference.animate_card_snap(card_reference, Vector2(960, 200), 3000)
...
func focus_card(battle_manager_reference, card_manager_reference):
...
func unfocus_card(battle_manager_reference, card_manager_reference):
