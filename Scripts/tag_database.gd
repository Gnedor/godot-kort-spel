...
const TAGS = [
	...
	{"name": "Crit", "description": "Card attacks add 10% Crit chance to all attacks (max 100%). A Crit deal 3x Damage"},
	{"name": "Echo", "description": "Card attacks apply one stack of Echo, when attacking with 3 stacks of Echo, draw one card from both decks"},
	]
