const TILES = { # "Namn" : [ability description, ability script, type]
	...
	"Group Dynamic" : ["Card played on this tile does 1.5x Damage for each of the same card currently played", "res://Scripts/TileAbilities/group_dynamic.gd", "OnAttack"],
