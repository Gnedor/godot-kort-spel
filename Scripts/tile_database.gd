const TILES = { # "Namn" : [ability description, ability script, type]
	...
	"Group Dynamic" : ["When card is played on this tile, it gains +3 Damage for each of the same card currently played", "res://Scripts/TileAbilities/group_dynamic.gd", "OnPlay"],
